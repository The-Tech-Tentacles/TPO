  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Posts, notices, and messages for students.
          </p>
        </div>
      </div>
      ...
      <Button
        ...
        size="lg"
        className="fixed bottom-6 right-6 h-14 rounded-full shadow-xl gap-2"
      >
                ...
                pollOptions:
                  type === "Poll"
                    ? pollOptionsText
                        .split("\n")
                        .filter((t) => t.trim())
                        .map((t, i) => ({ id: `opt-${i}`, text: t.trim(), votes: 0 }))
                    : undefined,
              })
            }
