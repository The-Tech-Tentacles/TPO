  ...
  return (
    <DropdownMenu onOpenChange={(open) => {
      ...
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" className="rounded-full hover:bg-white/50 dark:hover:bg-slate-800/40 transition-colors">
        ...
        {showThemeOptions && (
          <div className="bg-slate-100/50 dark:bg-slate-800/50 rounded-md mx-1 my-1 p-1 flex flex-col gap-0.5 shadow-inner border border-slate-200/50 dark:border-slate-700/50 animate-in slide-in-from-top-1 fade-in-0 duration-200">
            <DropdownMenuItem 
              ...
              className={cn("pl-8 text-sm", theme === "light" && "bg-slate-200/80 dark:bg-slate-700/80 font-medium")}
            >
              Light
            ...
            <DropdownMenuItem 
              ...
              className={cn("pl-8 text-sm", theme === "dark" && "bg-slate-200/80 dark:bg-slate-700/80 font-medium")}
            >
              Dark
            ...
            <DropdownMenuItem 
              ...
              className={cn("pl-8 text-sm", theme === "system" && "bg-slate-200/80 dark:bg-slate-700/80 font-medium")}
            >
              System
